...
The first set is the Manatee Synoptic Survey Observation Locations from The Florida Fish and Wildlife Conservation Commission.
This data represents a statewide survey of manatee populations from 1991 through 2019.
...
Our second data set is from the US Department of the Interior.
It comes from a GPS telemetry of 40 manatees in Southwest Florida from 2002 to 2008.
...
This data comes from the US Department of the Interior's GPS telemetry.
...
The first data set was provided by the Florida Coastal Everglades LTER. They conducted a project to measure the impact of ocean temperature on various types of sea grass.
...
Our second data set comes from the US Department of the Interior.
It is the data set that aligns with our second set of manatee data.
...
Our manatee data will come from \_\_\_\_ and \_\_\_\_.
The ocean data is from \_\_\_ and \_\_\_ .

Our study area will in Southern Florida, in Everglades National Park as well as the surrounding ocean area.
...
The manatee data from \_\_\_ currently comes from all of Florida.
...
Our second manatee data set from \_\_\_ shows how 40 different manatees moved over a span of 5 years.
...
The only flaw in these sets are some missing data points or extreme outlires.
